        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    {
                        Console.WriteLine("Pozitif değerler giriniz lütfen ...");
                    }
                }
                ...
                for (int j = 0; j < 5; j++)
                {
                    ...
                    else if (j == 1)
                    {
                        while (true)
                        {
                            ...
                            {
                                Console.WriteLine("Ad değişkeni tamamen sayılardan oluşamaz");
                            }
                            catch (Exception ex)
                            {
                    ...
                    else if (j == 2)
                    {
                        while (true)
                        {
                            ...
                            {
                                Console.WriteLine("Soyad değişkeni tamamen sayılardan oluşamaz");
                            }
                            catch (Exception ex)
                            {
                                Console.WriteLine("Soyad girme kısmında anlaşılamayan bir hata oluştu ...");
                            }
                        }
                    }
                    else if (j == 3)
            ...
            for (int k = 0; k < ogrenci_Sayi; k++)
            {
                ...
                Console.WriteLine();
                Console.WriteLine($"{k+1}-nci ögrenci :");
                Console.WriteLine();
                Console.Write("{0,-10}{1,-30}{2,-30}{3,-10}{4,-10}{5,-20}{6,-10}", $"{dizi[k,0]}", $"{dizi[k,1]}", $"{dizi[k,2]}", $"{dizi[k,3]}", $"{dizi[k,4]}", $"{dizi[k,5]}", $"{dizi[k,6]}");
                Console.WriteLine();
            }
